 ...
 */
final class Version20240401150236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pnpuser_pwreset_request CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pnpuser_pwreset_request CHANGE user_id user_id INT NOT NULL');
    }
}
